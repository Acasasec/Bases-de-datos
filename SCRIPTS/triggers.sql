...
for each row
insert into taller.historial_vehiculos (usuario, fecha, Operaci贸n, ID_vehiculo_NEW,Matricula_NEW,
...
for each row
insert into taller.historial_vehiculos (usuario, fecha, Operaci贸n, ID_vehiculo_OLD,ID_vehiculo_NEW,
...
VALUES (current_user(), now(),'MODIFICACI脫N',
...
for each row
insert into taller.historial_vehiculos (usuario, fecha, Operaci贸n, ID_vehiculo_OLD,Matricula_OLD,
...
FOR EACH ROW
	INSERT INTO REG_PRODUCTOS(CODIGOARTICULO, NOMBREARTICULO, PRECIO, INSERTADO) VALUES(NEW.CODIGOARTICULO, NEW.NOMBREARTICULO, NEW.PRECIO, NOW()); 

INSERT INTO productos (CODIGOARTICULO, NOMBREARTICULO, PRECIO, PAISDEORIGEN) VALUES ('AR75, 'PANTALON', 50, 'ESPA袮');
